...
End Custom UFW by clusterednetworksv
Add Valve Anti-DDoS Rules
iptables -I INPUT 4 -p udp --dport 27015 -m state --state NEW -m recent --name VALVE_ANTIDDOS --set
iptables -I INPUT 4 -p udp --dport 27016 -m state --state NEW -m recent --name VALVE_ANTIDDOS --set
iptables -I INPUT 4 -p udp --dport 27017 -m state --state NEW -m recent --name VALVE_ANTIDDOS --set

Additional rules from the provided script
